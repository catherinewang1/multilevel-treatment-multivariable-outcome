...
h_plot_ebcipval <- function(plot_df_one, plot_df_summary, ranks, save_folder, height=NULL, width=NULL, save_ggplot=NULL) {
  ...
  temp_df$methodrank = mapply(FUN = methodrank_nicenames, method_name =  plot_df_summ$method, rank_ = plot_df_summ$rank) |> unname()
  temp_df$methodrank = factor(plot_df_summ$methodrank, levels = methodrank_nicenames_order)
