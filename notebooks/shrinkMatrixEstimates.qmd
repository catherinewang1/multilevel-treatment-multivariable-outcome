...
unshrunk       = lowrankres$lowrankdataframe |> dplyr::filter(group == 'original') |>
                 dplyr::select(-group) |>
...
shrinkagepoint = lowrankres$lowrankdataframe |> dplyr::filter(group == 'rank=15') |> 
...
testebcires = ebci::ebci(formula = sprintf('%s - shrinkage_point ~ 0', 'unshrunk_point'),
